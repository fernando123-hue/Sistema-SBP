...
| C-16 | BAIXO | `src/app/api/notas/route.ts:57` | Qualquer colaborador cria notas sem limite, e toda tela de trabalho carrega todas as notas gerais sem teto | **Corrigido** (PR #PRNUM, `§ AT-44`): 20 notas por minuto por pessoa; leitura da tela com teto por faixa de relevância (resultado idêntico); listagem com teto de 200 e `truncado` |
