...
| N-28 | BAIXO | `src/app/acesso/page.tsx:133` | Mensagens em inglês, com ids internos e com notas de desenvolvimento na tela | **Confirmado; (a) corrigido** (PR #114): validação em português de gente (`core/mensagem-de-validacao.ts`, servidor e tela), permissão negada sem papel/operação/permitidos, 14 `ErroDeNegocio` sem id com varredura em teste; **(b) textos das telas: PR seguinte** |
