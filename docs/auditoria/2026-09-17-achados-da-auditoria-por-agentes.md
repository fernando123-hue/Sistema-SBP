...
**Atualização de 17/09/2026, manhã:** N-01 verificado lendo o código — confirmado e corrigido (PR #57); C-01 corrigido (a contagem acima é a do fim da auditoria).
...
| C-02 | ALTO | `src/adapters/ingestao-graph.ts:115` | Um único e-mail externo grande demais trava toda a ingestão, e a trava não sai sozinha | |
| C-03 | ALTO | `src/adapters/ingestao-graph.ts:98` | Um único e-mail de fora (ou o 201º e-mail da caixa) derruba a ingestão real para sempre | |
