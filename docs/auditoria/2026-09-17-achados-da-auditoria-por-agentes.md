...
| C-18 | BAIXO | `src/servicos/autenticacao.ts:91` | A mensagem de conta bloqueada enumera contas ativas, e a premissa registrada no comentário está errada | **Parcial** (PR #92): o bloqueio passou a esperar o piso de 250 ms (respondia em 5 ms) e o comentário falso foi corrigido; a mensagem é decisão do dono — `DECISOES.md § H.4` item 33 |
