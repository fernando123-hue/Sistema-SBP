...
| C-15 | BAIXO | `src/adapters/assistente-modelo.ts:111` | O assistente grava no log texto livre escolhido pelo modelo, o que abre caminho para a pergunta, com e-mail colado, chegar ao log | **Corrigido** (PR #PRNUM): o aviso grava só quantas citações foram descartadas, nunca o texto; teste com CPF sintético no `verbetesUsados` |
