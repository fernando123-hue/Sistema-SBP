...
| C-19 | BAIXO | `src/servicos/autenticacao.ts:203` | Tentativas contra e-mail inexistente, falhas na troca de senha e recusas por bloqueio não entram na trilha | **Corrigido** (PR #PRNUM, `§ AT-45`): as quatro recusas entram na trilha da conta; e-mail inexistente vira evento sem o endereço. Alerta por volume fica anotado para depois |
