...
| C-18 | BAIXO | `src/servicos/autenticacao.ts:91` | A mensagem de conta bloqueada enumera contas ativas, e a premissa registrada no comentário está errada | **Corrigido** (PR #92 e PR #PRNUM, `§ A57`): o bloqueio espera o piso de 250 ms (respondia em 5 ms); por decisão do dono, a conta travada responde como qualquer recusa, e a tela mostra uma orientação fixa de esperar |
