...
**Hipótese:** o classificador externo (`A62`) não precisa de data completa nem de valor com 5 ou mais dígitos para dizer a categoria ou a suspeita de um pedido. `vencimento 30/09/2026`, `2026-09-26`, `anos 2025-2026` e `R$ 350,00` viram `[número]`; ano sozinho (`2026`) e valor curto (`R$ 35,00`) ficam.
...
**Status:** 🟡 assumida; fixada em `protecao-para-fornecedor-externo.test.ts` ("data completa e valor longo", "valor curto e ano sozinho").
