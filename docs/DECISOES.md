...
**Status:** 🟡 assumida; fixada em `protecao-para-fornecedor-externo.test.ts` ("data completa e valor longo", "valor curto e ano sozinho", "lista de números pequenos, notas e horário", "contagem pequena depois de palavra-chave").
