...
> 3. **Revisão de segurança da fase 1**, encomendada em 15/09/2026 a um agente só de leitura (busca por CPF protegido, expurgos, trilha sem dado pessoal, aviso do gestor). Se o resultado não estiver registrado aqui nem em `docs/auditoria/`, ela não terminou — refaça antes de tratar a fase 1 como conferida.
