...
> 3b. **Pendência nova (17/09):** colisão proposital de `internetMessageId` some sem evento — ver `DECISOES.md § AT-35`, parágrafo *Pendência*. Tratar junto com o C-04 (mesma coluna).
