...
const CorpoSchema = z.object({
  ...
  motivo: z.enum(['transferencia', 'devolucao']).default('transferencia'),
})

/**
 * Transfere ou devolve um item.
 *
...
export async function POST(
  ...
  return rota(async () => {
    ...
    return responder({ itemId: id, para: corpo.paraColaboradorId, motivo: corpo.motivo })
  })
}
